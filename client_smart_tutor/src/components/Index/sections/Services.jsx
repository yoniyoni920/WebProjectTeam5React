...
const Services = () => (
  <section id="services" className="services-section py-12 bg-gradient-to-br from-[#EAEFEF] via-[#B8CFCE]/30 to-[#B8CFCE]/50 border border-[#7F8CAA] px-6 text-center rounded-3xl max-w-3xl mx-auto my-12 shadow-lg">
